...
prs.all <- read.table("DIAGRAM2017_META_PRSice_avg_PAPG21-3_1000gSAS_GRCh37.best", header = TRUE)
...
tiff("DIAGRAM2017_META_PRS_densityplot.tiff", units="in", width=10, height=10, res=300)
