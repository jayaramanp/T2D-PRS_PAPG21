...
prs.all <- read.table("MAGIC_FG_PRSice_avg_PAPG21-3_1000gSAS_GRCh37.best", header = TRUE)
...
tiff("MAGIC_FG_PRS_densityplot.tiff", units="in", width=10, height=10, res=300)
