...
prs.all <- read.table("UKBB_EXOME_CAD_PRSice_avg_PAPG21-3_1000gSAS_GRCh37.best", header = TRUE)
...
tiff("UKBB_CAD_PRS_densityplot.tiff", units="in", width=10, height=10, res=300)
